...
<div align="justify">All the lncRNAs identified across the nine cucurbit species can be found in <a href="Tables/LncRNAs">Tables/LncRNAs</a> in several formats (fasta, tsv and gtf) so that they can be used by the scientific community. Also, in <a href="Tables/Both">Tables/Both</a> we can find the files containing both categories, lncRNAs and protein-coding genes (PCGs). </div>
...
* <div align="justify"> Villalba-Bermell P., Marquez-Molins J., Gomez G. A multispecies study reveals the diversity and potential regulatory role of long noncoding RNAs in cucurbits. Plant J. 2024 Sep 10. doi: 10.1111/tpj.17013. </div>
