...
DB = read.table(paste0(WD, "/Database/Database_LncRNAs.tsv"), header = T, sep = "\t", quote = "\"")
...
png(filename = paste0(WD, "/Figures/Circos/r/density_by_class_code-ALL.png"), height = 8000, width = 8000, res = 800)
...
png(filename = paste0(WD, "/Figures/Circos/r/density_by_class_code-LOW.png"), height = 8000, width = 8000, res = 800)
circos.initializeWithIdeogram(chrs.sizes, plotType = c("axis", "labels"), labels.cex = 2)
...
png(filename = paste0(WD, "/Figures/Circos/r/density_by_class_code-MEDIUM.png"), height = 8000, width = 8000, res = 800)
circos.initializeWithIdeogram(chrs.sizes, plotType = c("axis", "labels"), labels.cex = 2)
...
png(filename = paste0(WD, "/Figures/Circos/r/density_by_class_code-HIGH.png"), height = 8000, width = 8000, res = 800)
circos.initializeWithIdeogram(chrs.sizes, plotType = c("axis", "labels"), labels.cex = 2)
...
for (chr in chrs) {
  ...
  png(filename = paste0(WD, "/Figures/Circos/r/density_by_class_code-", chr, ".png"), height = 8000, width = 8000, res = 800)
