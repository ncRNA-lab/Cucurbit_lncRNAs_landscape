...
for (spe in species) {
  ...
  if (length(files) > 0) {
    ...
    for (SRA.Study in SRA.Studies) {
      ...
      # Load table with the tissue specificity results and the log-tranformed expression values. 
      tab_median_TAU = read.table(paste0(path_tissue_specificity, "/approach_1/ALL/", flag, "/STEP2/", spe, "/", SRA.Study, "_median-TAU.tsv"), sep = "\t", header = T, quote = "\"")
      ...
      ggsave(paste0(path_tissue_specificity, "/approach_1/ALL/", flag, "/STEP3/", spe, "/", SRA.Study, "_median-TAU-Violin.png"), height = 10, width = 10, dpi = 600)
      ggsave(paste0(path_tissue_specificity, "/approach_1/ALL/", flag, "/STEP3/", spe, "/", SRA.Study, "_median-TAU-Violin.pdf"), height = 10, width = 10, dpi = 600)
      ...
      ggsave(paste0(path_tissue_specificity, "/approach_1/ALL/", flag, "/STEP3/", spe, "/", SRA.Study, "_median-TAU-Violin_by_class_code.png"), height = 10, width = 20, dpi = 600)
      ggsave(paste0(path_tissue_specificity, "/approach_1/ALL/", flag, "/STEP3/", spe, "/", SRA.Study, "_median-TAU-Violin_by_class_code.pdf"), height = 10, width = 20, dpi = 600)
...
write.table(TAB_median_TAU_mod, paste0(path_tissue_specificity, "/approach_1/ALL/", flag, "/STEP3/median-TAU.tsv"), sep = "\t", quote = F, row.names = F, col.names = T)
...
ggsave(paste0(path_tissue_specificity, "/approach_1/ALL/", flag, "/STEP3/median-TAU-Violin_by_class_code.png"), height = 20, width = 10, dpi = 600)
ggsave(paste0(path_tissue_specificity, "/approach_1/ALL/", flag, "/STEP3/median-TAU-Violin_by_class_code.pdf"), height = 20, width = 10, dpi = 600)
...
ggsave(paste0(path_tissue_specificity, "/approach_1/ALL/", flag, "/STEP3/median-TAU-Violin_by_class_code-jitter.png"), height = 20, width = 10, dpi = 600)
ggsave(paste0(path_tissue_specificity, "/approach_1/ALL/", flag, "/STEP3/median-TAU-Violin_by_class_code-jitter.pdf"), height = 20, width = 10, dpi = 600)
