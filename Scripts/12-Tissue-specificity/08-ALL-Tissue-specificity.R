...
for (i in 1:length(species_short_name)) {
  ...
  # Directories.
  if (!dir.exists(paste0(path_tissue_specificity, "/approach_1/ALL/", flag, "/STEP8"))){
    dir.create(paste0(path_tissue_specificity, "/approach_1/ALL/", flag, "/STEP8"))
  }
  if (!dir.exists(paste0(path_tissue_specificity, "/approach_1/ALL/", flag, "/STEP8/", spe))){
    dir.create(paste0(path_tissue_specificity, "/approach_1/ALL/", flag, "/STEP8/", spe))
  }
  ...
  if (length(files) > 0) {
    ...
    for (SRA.Study in SRA.Studies) {
      ...
      tab_mean_TAU_1 = read.table(paste0(path_tissue_specificity, "/approach_1/ALL/", flag, "/STEP1/", spe, "/", SRA.Study, "_mean.tsv"), sep = "\t", header = T, quote = "\"")
      ...
      tab_mean_TAU_2 = read.table(paste0(path_tissue_specificity, "/approach_1/ALL/", flag, "/STEP2/", spe, "/", SRA.Study, "_mean-TAU.tsv"), sep = "\t", header = T, quote = "\"")
      ...
      tab_mean_TAU_3 = read.table(paste0(path_tissue_specificity, "/approach_1/ALL/", flag, "/STEP7/", spe, "/", SRA.Study, "_mean.tsv"), sep = "\t", header = T, quote = "\"")
      ...
      rm(list = c("tab_mean_TAU_1", "tab_mean_TAU_1_long", "tab_mean_TAU_1_long_filt", "tab_mean_TAU_2", "tab_mean_TAU_3"))
      ...
      # Save table.
      write.table(tab_mean_TAU, paste0(path_tissue_specificity, "/approach_1/ALL/", flag, "/STEP8/", spe, "/", SRA.Study, "_mean-ALL.tsv"), sep = "\t", quote = F, row.names = F, col.names = T)
...
write.table(TAB_mean, paste0(path_tissue_specificity, "/approach_1/ALL/", flag, "/STEP8/mean-ALL.tsv"), sep = "\t", quote = F, row.names = F, col.names = T)
...
if (!dir.exists(paste0(path_tissue_specificity, "/approach_1/ALL/", flag, "/STEP8/Figures"))){
  dir.create(paste0(path_tissue_specificity, "/approach_1/ALL/", flag, "/STEP8/Figures"))
}
...
for (con in confidences) {
  ...
  if (!is.null(TAB_mean_temp)) {
    ...
    ggsave(paste0(path_tissue_specificity, "/approach_1/ALL/", flag, "/STEP8/Figures/mean-", con, ".png"), height = 14, width = 16, dpi = 600, bg = "white")
    #ggsave(paste0(path_tissue_specificity, "/approach_1/ALL/", flag, "/STEP8/Figures/mean-", con, ".pdf"), height = 14, width = 16, dpi = 600, bg = "white")
  }
}
...
for (i in 1:length(species_short_name)) {
  ...
  for (con in confidences) {
    ...
    if (!is.null(TAB_mean_temp)) {
      ...
      ggsave(paste0(path_tissue_specificity, "/approach_1/ALL/", flag, "/STEP8/", spe, "/mean-", con, ".png"), height = 14, width = 16, dpi = 600, bg = "white")
      #ggsave(paste0(path_tissue_specificity, "/approach_1/ALL/", flag, "/STEP8/", spe, "/mean-", con, ".pdf"), height = 14, width = 16, dpi = 600, bg = "white")
    }
  }
}
