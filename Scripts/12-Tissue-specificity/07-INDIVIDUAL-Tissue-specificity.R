################################################################################
#
# INDIVIDUAL: TISSUE SPECIFICITY STUDY: APPROACH 1 - STEP 7
#
...
for (i in 1:length(species_short_name)) {
  ...
  # Directories.
  if (!dir.exists(paste0(path_tissue_specificity, "/approach_1/INDIVIDUAL/", flag, "/STEP7"))){
    dir.create(paste0(path_tissue_specificity, "/approach_1/INDIVIDUAL/", flag, "/STEP7"))
  }
  if (!dir.exists(paste0(path_tissue_specificity, "/approach_1/INDIVIDUAL/", flag, "/STEP7/", spe))){
    dir.create(paste0(path_tissue_specificity, "/approach_1/INDIVIDUAL/", flag, "/STEP7/", spe))
  }
  ...
  if (length(files) > 0) {
    ...
    for (SRA.Study in SRA.Studies) {
      ...
      # Save table.
      write.table(tab_mean_merged, paste0(path_tissue_specificity, "/approach_1/INDIVIDUAL/", flag, "/STEP7/", spe, "/", SRA.Study, "_mean.tsv"), sep = "\t", quote = F, row.names = F, col.names = T)
      ...
      rm(list = c("tab_mean_TAU", "tab_mean_TAU_G", "tab_mean_TAU_L","tab_info", "tab_mean_merged"))
    }
  }
}

write.table(TAB_mean, paste0(path_tissue_specificity, "/approach_1/INDIVIDUAL/", flag, "/STEP7/mean.tsv"), sep = "\t", quote = F, row.names = F, col.names = T)
...
if (!dir.exists(paste0(path_tissue_specificity, "/approach_1/INDIVIDUAL/", flag, "/STEP7/Figures"))){
  dir.create(paste0(path_tissue_specificity, "/approach_1/INDIVIDUAL/", flag, "/STEP7/Figures"))
}
...
if (!dir.exists(paste0(path_tissue_specificity, "/approach_1/INDIVIDUAL/", flag, "/STEP7/Figures/ALL"))){
  dir.create(paste0(path_tissue_specificity, "/approach_1/INDIVIDUAL/", flag, "/STEP7/Figures/ALL"))
}
...
for (con in confidences) {
  ...
  ggsave(paste0(path_tissue_specificity, "/approach_1/INDIVIDUAL/", flag, "/STEP7/Figures/ALL/mean-SEQ_OF-", con, ".png"), height = 8, width = 16, dpi = 600, bg = "white")
  #ggsave(paste0(path_tissue_specificity, "/approach_1/INDIVIDUAL/", flag, "/STEP7/Figures/ALL/mean-SEQ_OF-", con, ".pdf"), height = 8, width = 16, dpi = 600, bg = "white")
  
  gg_final_OF_facet = ggarrange(gg1_facet, gg2, ncol = 2, widths = c(0.60, 0.40))
  
  ggsave(paste0(path_tissue_specificity, "/approach_1/INDIVIDUAL/", flag, "/STEP7/Figures/ALL/mean-SEQ_OF-", con, "_facet.png"), height = 8, width = 20, dpi = 600, bg = "white")
  #ggsave(paste0(path_tissue_specificity, "/approach_1/INDIVIDUAL/", flag, "/STEP7/Figures/ALL/mean-SEQ_OF-", con, "_facet.pdf"), height = 8, width = 20, dpi = 600, bg = "white")
  ...
  ggsave(paste0(path_tissue_specificity, "/approach_1/INDIVIDUAL/", flag, "/STEP7/Figures/ALL/mean-POS-", con, ".png"), height = 8, width = 16, dpi = 600, bg = "white")
  #ggsave(paste0(path_tissue_specificity, "/approach_1/INDIVIDUAL/", flag, "/STEP7/Figures/ALL/mean-POS-", con, ".pdf"), height = 8, width = 16, dpi = 600, bg = "white")
  
  gg_final_Pos_facet = ggarrange(gg1_facet, gg2, ncol = 2, widths = c(0.60, 0.40))
  
  ggsave(paste0(path_tissue_specificity, "/approach_1/INDIVIDUAL/", flag, "/STEP7/Figures/ALL/mean-POS-", con, "_facet.png"), height = 8, width = 20, dpi = 600, bg = "white")
  #ggsave(paste0(path_tissue_specificity, "/approach_1/INDIVIDUAL/", flag, "/STEP7/Figures/ALL/mean-POS-", con, "_facet.pdf"), height = 8, width = 20, dpi = 600, bg = "white")
  ...
  ggsave(paste0(path_tissue_specificity, "/approach_1/INDIVIDUAL/", flag, "/STEP7/Figures/ALL/mean-", con, ".png"), height = 16, width = 16, dpi = 600, bg = "white")
  #ggsave(paste0(path_tissue_specificity, "/approach_1/INDIVIDUAL/", flag, "/STEP7/Figures/ALL/mean-", con, ".pdf"), height = 16, width = 16, dpi = 600, bg = "white")
  
  gg_final_facet = ggarrange(gg_final_OF_facet, gg_final_Pos_facet, nrow = 2)
  
  ggsave(paste0(path_tissue_specificity, "/approach_1/INDIVIDUAL/", flag, "/STEP7/Figures/ALL/mean-", con, "_facet.png"), height = 16, width = 20, dpi = 600, bg = "white")
  #ggsave(paste0(path_tissue_specificity, "/approach_1/INDIVIDUAL/", flag, "/STEP7/Figures/ALL/mean-", con, "_facet.pdf"), height = 16, width = 20, dpi = 600, bg = "white")
...
if (!dir.exists(paste0(path_tissue_specificity, "/approach_1/INDIVIDUAL/", flag, "/STEP7/Figures/CLASS_CODES"))){
  dir.create(paste0(path_tissue_specificity, "/approach_1/INDIVIDUAL/", flag, "/STEP7/Figures/CLASS_CODES"))
}
...
for (con in confidences) {
  ...
  ggsave(paste0(path_tissue_specificity, "/approach_1/INDIVIDUAL/", flag, "/STEP7/Figures/CLASS_CODES/mean-SEQ_OF-", con, ".png"), height = 8, width = 16, dpi = 600, bg = "white")
  #ggsave(paste0(path_tissue_specificity, "/approach_1/INDIVIDUAL/", flag, "/STEP7/Figures/CLASS_CODES/mean-SEQ_OF-", con, ".pdf"), height = 8, width = 16, dpi = 600, bg = "white")
  
  gg_final_OF_facet = ggarrange(gg1_facet, gg2, ncol = 2, widths = c(0.60, 0.40))
  
  ggsave(paste0(path_tissue_specificity, "/approach_1/INDIVIDUAL/", flag, "/STEP7/Figures/CLASS_CODES/mean-SEQ_OF-", con, "_facet.png"), height = 8, width = 20, dpi = 600, bg = "white")
  #ggsave(paste0(path_tissue_specificity, "/approach_1/INDIVIDUAL/", flag, "/STEP7/Figures/CLASS_CODES/mean-SEQ_OF-", con, "_facet.pdf"), height = 8, width = 20, dpi = 600, bg = "white")
  ...
  ggsave(paste0(path_tissue_specificity, "/approach_1/INDIVIDUAL/", flag, "/STEP7/Figures/CLASS_CODES/mean-POS-", con, ".png"), height = 8, width = 16, dpi = 600, bg = "white")
  #ggsave(paste0(path_tissue_specificity, "/approach_1/INDIVIDUAL/", flag, "/STEP7/Figures/CLASS_CODES/mean-POS-", con, ".pdf"), height = 8, width = 16, dpi = 600, bg = "white")
  
  gg_final_Pos_facet = ggarrange(gg1_facet, gg2, ncol = 2, widths = c(0.60, 0.40))
  
  ggsave(paste0(path_tissue_specificity, "/approach_1/INDIVIDUAL/", flag, "/STEP7/Figures/CLASS_CODES/mean-POS-", con, "_facet.png"), height = 8, width = 20, dpi = 600, bg = "white")
  #ggsave(paste0(path_tissue_specificity, "/approach_1/INDIVIDUAL/", flag, "/STEP7/Figures/CLASS_CODES/mean-POS-", con, "_facet.pdf"), height = 8, width = 20, dpi = 600, bg = "white")
  ...
  ggsave(paste0(path_tissue_specificity, "/approach_1/INDIVIDUAL/", flag, "/STEP7/Figures/CLASS_CODES/mean-", con, ".png"), height = 16, width = 16, dpi = 600, bg = "white")
  #ggsave(paste0(path_tissue_specificity, "/approach_1/INDIVIDUAL/", flag, "/STEP7/Figures/CLASS_CODES/mean-", con, ".pdf"), height = 16, width = 16, dpi = 600, bg = "white")
  
  gg_final_facet = ggarrange(gg_final_OF_facet, gg_final_Pos_facet, nrow = 2)
  
  ggsave(paste0(path_tissue_specificity, "/approach_1/INDIVIDUAL/", flag, "/STEP7/Figures/CLASS_CODES/mean-", con, "_facet.png"), height = 16, width = 20, dpi = 600, bg = "white")
  #ggsave(paste0(path_tissue_specificity, "/approach_1/INDIVIDUAL/", flag, "/STEP7/Figures/CLASS_CODES/mean-", con, "_facet.pdf"), height = 16, width = 20, dpi = 600, bg = "white")
...
for (i in 1:length(species_short_name)) {
  ...
  if (length(files) > 0) {
    ...
    for (SRA.Study in SRA.Studies) {
      ...
      if (!dir.exists(paste0(path_tissue_specificity, "/approach_1/INDIVIDUAL/", flag, "/STEP7/", spe, "/ALL"))){
        dir.create(paste0(path_tissue_specificity, "/approach_1/INDIVIDUAL/", flag, "/STEP7/", spe, "/ALL"))
      }
      ...
      for (con in confidences) {
        ...
        ggsave(paste0(path_tissue_specificity, "/approach_1/INDIVIDUAL/", flag, "/STEP7/", spe, "/ALL/", SRA.Study, "_mean-SEQ_OF-", con, ".png"), height = 8, width = 16, dpi = 600, bg = "white")
        #ggsave(paste0(path_tissue_specificity, "/approach_1/INDIVIDUAL/", flag, "/STEP7/", spe, "/ALL/", SRA.Study, "_mean-SEQ_OF-", con, ".pdf"), height = 8, width = 16, dpi = 600, bg = "white")
        
        gg_final_OF_facet = ggarrange(gg1_facet, gg2, ncol = 2, widths = c(0.60, 0.40))
        
        ggsave(paste0(path_tissue_specificity, "/approach_1/INDIVIDUAL/", flag, "/STEP7/", spe, "/ALL/", SRA.Study, "_mean-SEQ_OF-", con, "_facet.png"), height = 8, width = 20, dpi = 600, bg = "white")
        #ggsave(paste0(path_tissue_specificity, "/approach_1/INDIVIDUAL/", flag, "/STEP7/", spe, "/ALL/", SRA.Study, "_mean-SEQ_OF-", con, "_facet.pdf"), height = 8, width = 20, dpi = 600, bg = "white")
        ...
        ggsave(paste0(path_tissue_specificity, "/approach_1/INDIVIDUAL/", flag, "/STEP7/", spe, "/ALL/", SRA.Study, "_mean-POS-", con, ".png"), height = 8, width = 16, dpi = 600, bg = "white")
        #ggsave(paste0(path_tissue_specificity, "/approach_1/INDIVIDUAL/", flag, "/STEP7/", spe, "/ALL/", SRA.Study, "_mean-POS-", con, ".pdf"), height = 8, width = 16, dpi = 600, bg = "white")
        
        gg_final_Pos_facet = ggarrange(gg1_facet, gg2, ncol = 2, widths = c(0.60, 0.40))
        
        ggsave(paste0(path_tissue_specificity, "/approach_1/INDIVIDUAL/", flag, "/STEP7/", spe, "/ALL/", SRA.Study, "_mean-POS-", con, "_facet.png"), height = 8, width = 20, dpi = 600, bg = "white")
        #ggsave(paste0(path_tissue_specificity, "/approach_1/INDIVIDUAL/", flag, "/STEP7/", spe, "/ALL/", SRA.Study, "_mean-POS-", con, "_facet.pdf"), height = 8, width = 20, dpi = 600, bg = "white")
        ...
        ggsave(paste0(path_tissue_specificity, "/approach_1/INDIVIDUAL/", flag, "/STEP7/", spe, "/ALL/", SRA.Study, "_mean-", con, ".png"), height = 16, width = 16, dpi = 600, bg = "white")
        #ggsave(paste0(path_tissue_specificity, "/approach_1/INDIVIDUAL/", flag, "/STEP7/", spe, "/ALL/", SRA.Study, "_mean-", con, ".pdf"), height = 16, width = 16, dpi = 600, bg = "white")
        
        gg_final_facet = ggarrange(gg_final_OF_facet, gg_final_Pos_facet, nrow = 2)
        
        ggsave(paste0(path_tissue_specificity, "/approach_1/INDIVIDUAL/", flag, "/STEP7/", spe, "/ALL/", SRA.Study, "_mean-", con, "_facet.png"), height = 16, width = 20, dpi = 600, bg = "white")
        #ggsave(paste0(path_tissue_specificity, "/approach_1/INDIVIDUAL/", flag, "/STEP7/", spe, "/ALL/", SRA.Study, "_mean-", con, "_facet.pdf"), height = 16, width = 20, dpi = 600, bg = "white")
      ...
      if (!dir.exists(paste0(path_tissue_specificity, "/approach_1/INDIVIDUAL/", flag, "/STEP7/", spe, "/CLASS_CODES"))){
        dir.create(paste0(path_tissue_specificity, "/approach_1/INDIVIDUAL/", flag, "/STEP7/", spe, "/CLASS_CODES"))
      }
      ...
      for (con in confidences) {
        ...
        ggsave(paste0(path_tissue_specificity, "/approach_1/INDIVIDUAL/", flag, "/STEP7/", spe, "/CLASS_CODES/", SRA.Study, "_mean-SEQ_OF-", con, ".png"), height = 8, width = 16, dpi = 600, bg = "white")
        #ggsave(paste0(path_tissue_specificity, "/approach_1/INDIVIDUAL/", flag, "/STEP7/", spe, "/CLASS_CODES/", SRA.Study, "_mean-SEQ_OF-", con, ".pdf"), height = 8, width = 16, dpi = 600, bg = "white")
        
        gg_final_OF_facet = ggarrange(gg1_facet, gg2, ncol = 2, widths = c(0.60, 0.40))
        
        ggsave(paste0(path_tissue_specificity, "/approach_1/INDIVIDUAL/", flag, "/STEP7/", spe, "/CLASS_CODES/", SRA.Study, "_mean-SEQ_OF-", con, "_facet.png"), height = 8, width = 20, dpi = 600, bg = "white")
        #ggsave(paste0(path_tissue_specificity, "/approach_1/INDIVIDUAL/", flag, "/STEP7/", spe, "/CLASS_CODES/", SRA.Study, "_mean-SEQ_OF-", con, "_facet.pdf"), height = 8, width = 20, dpi = 600, bg = "white")
        ...
        ggsave(paste0(path_tissue_specificity, "/approach_1/INDIVIDUAL/", flag, "/STEP7/", spe, "/CLASS_CODES/", SRA.Study, "_mean-POS-", con, ".png"), height = 8, width = 16, dpi = 600, bg = "white")
        #ggsave(paste0(path_tissue_specificity, "/approach_1/INDIVIDUAL/", flag, "/STEP7/", spe, "/CLASS_CODES/", SRA.Study, "_mean-POS-", con, ".pdf"), height = 8, width = 16, dpi = 600, bg = "white")
        
        gg_final_Pos_facet = ggarrange(gg1_facet, gg2, ncol = 2, widths = c(0.60, 0.40))
        
        ggsave(paste0(path_tissue_specificity, "/approach_1/INDIVIDUAL/", flag, "/STEP7/", spe, "/CLASS_CODES/", SRA.Study, "_mean-POS-", con, "_facet.png"), height = 8, width = 20, dpi = 600, bg = "white")
        #ggsave(paste0(path_tissue_specificity, "/approach_1/INDIVIDUAL/", flag, "/STEP7/", spe, "/CLASS_CODES/", SRA.Study, "_mean-POS-", con, "_facet.pdf"), height = 8, width = 20, dpi = 600, bg = "white")
        ...
        ggsave(paste0(path_tissue_specificity, "/approach_1/INDIVIDUAL/", flag, "/STEP7/", spe, "/CLASS_CODES/", SRA.Study, "_mean-", con, ".png"), height = 16, width = 16, dpi = 600, bg = "white")
        #ggsave(paste0(path_tissue_specificity, "/approach_1/INDIVIDUAL/", flag, "/STEP7/", spe, "/CLASS_CODES/", SRA.Study, "_mean-", con, ".pdf"), height = 16, width = 16, dpi = 600, bg = "white")
        
        gg_final_facet = ggarrange(gg_final_OF_facet, gg_final_Pos_facet, nrow = 2)
        
        ggsave(paste0(path_tissue_specificity, "/approach_1/INDIVIDUAL/", flag, "/STEP7/", spe, "/CLASS_CODES/", SRA.Study, "_mean-", con, "_facet.png"), height = 16, width = 20, dpi = 600, bg = "white")
        #ggsave(paste0(path_tissue_specificity, "/approach_1/INDIVIDUAL/", flag, "/STEP7/", spe, "/CLASS_CODES/", SRA.Study, "_mean-", con, "_facet.pdf"), height = 16, width = 20, dpi = 600, bg = "white")
...
# 
# ggsave(paste0(path_tissue_specificity, "/approach_1/INDIVIDUAL/", flag, "/STEP7/", spe, "/CLASS_CODES/", SRA.Study, "_mean-MOT.png"), height = 10, width = 15, dpi = 600)
# #ggsave(paste0(path_tissue_specificity, "/approach_1/INDIVIDUAL/", flag, "/STEP7/", spe, "/CLASS_CODES/", SRA.Study, "_mean-MOT.pdf"), height = 10, width = 15, dpi = 600)
