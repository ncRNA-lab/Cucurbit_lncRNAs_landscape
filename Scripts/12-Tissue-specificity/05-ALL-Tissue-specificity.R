...
for (i in 1:length(species_short_name)) {
  ...
  if (!dir.exists(paste0(path_tissue_specificity, "/approach_1/ALL/", flag, "/STEP5/", spe))){
    dir.create(paste0(path_tissue_specificity, "/approach_1/ALL/", flag, "/STEP5/", spe))
  }
  ...
  if (length(files) > 0) {
    ...
    for (SRA.Study in SRA.Studies) {
      ...
      # Save table.
      write.table(tab_mean_merged, paste0(path_tissue_specificity, "/approach_1/ALL/", flag, "/STEP5/", spe, "/", SRA.Study, "_mean-FEATURES.tsv"), sep = "\t", quote = F, row.names = F, col.names = T)
...
write.table(TAB_mean, paste0(path_tissue_specificity, "/approach_1/ALL/", flag, "/STEP5/mean-FEATURES.tsv"), sep = "\t", quote = F, row.names = F, col.names = T)
...
ggsave(paste0(path_tissue_specificity, "/approach_1/ALL/", flag, "/STEP5/mean-FEATURES.png"), height = 25, width = 25, dpi = 600)
ggsave(paste0(path_tissue_specificity, "/approach_1/ALL/", flag, "/STEP5/mean-FEATURES.pdf"), height = 25, width = 25, dpi = 600)
...
for (class in class_codes) {
  ...
  ggsave(paste0(path_tissue_specificity, "/approach_1/ALL/", flag, "/STEP5/mean-FEATURES-", gsub("/", "-", class), ".png"), height = 25, width = 25, dpi = 600)
  ggsave(paste0(path_tissue_specificity, "/approach_1/ALL/", flag, "/STEP5/mean-FEATURES-", gsub("/", "-", class), ".pdf"), height = 25, width = 25, dpi = 600)
...
for (i in 1:length(species_short_name)) {
  ...
  if (length(files) > 0) {
    ...
    for (SRA.Study in SRA.Studies) {
      ...
      # Save table.
      write.table(tab_median_merged, paste0(path_tissue_specificity, "/approach_1/ALL/", flag, "/STEP5/", spe, "/", SRA.Study, "_median-FEATURES.tsv"), sep = "\t", quote = F, row.names = F, col.names = T)
...
write.table(TAB_median, paste0(path_tissue_specificity, "/approach_1/ALL/", flag, "/STEP5/median-FEATURES.tsv"), sep = "\t", quote = F, row.names = F, col.names = T)
...
ggsave(paste0(path_tissue_specificity, "/approach_1/ALL/", flag, "/STEP5/median-FEATURES.png"), height = 25, width = 25, dpi = 600)
ggsave(paste0(path_tissue_specificity, "/approach_1/ALL/", flag, "/STEP5/median-FEATURES.pdf"), height = 25, width = 25, dpi = 600)
...
for (class in class_codes) {
  ...
  ggsave(paste0(path_tissue_specificity, "/approach_1/ALL/", flag, "/STEP5/median-FEATURES-", gsub("/", "-", class), ".png"), height = 25, width = 25, dpi = 600)
  ggsave(paste0(path_tissue_specificity, "/approach_1/ALL/", flag, "/STEP5/median-FEATURES-", gsub("/", "-", class), ".pdf"), height = 25, width = 25, dpi = 600)
