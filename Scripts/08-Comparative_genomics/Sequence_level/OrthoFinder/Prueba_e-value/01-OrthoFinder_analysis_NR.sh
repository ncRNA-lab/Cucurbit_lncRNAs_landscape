...
F="/storage/ncRNA/Projects/lncRNAs/Cucurbitaceae/Scripts/Pascual/08-comparative_genomics/Sequence_level/OrthoFinder/Prueba_e-value/Functions_NR.sh"
...
WD1=$WD/08-comparative_genomics/Sequence_level/OrthoFinder/nr/Prueba_e-value
if [ -d "$WD1" ]; then
	rm -r $WD1
fi
...
mkdir -p $WD/08-comparative_genomics/Sequence_level/OrthoFinder/nr/Prueba_e-value
