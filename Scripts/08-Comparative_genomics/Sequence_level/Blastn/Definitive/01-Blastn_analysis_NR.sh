...
#SBATCH --job-name=BNRdef					# Job name.
#SBATCH --output=Blastn_NR_definitive.log			# Standard output and error log.
...
F="/storage/ncRNA/Projects/lncRNAs/Cucurbitaceae/Scripts/Pascual/08-comparative_genomics/Sequence_level/Blastn/Definitive/Functions_NR.sh"
...
WD1=$WD/08-comparative_genomics/Sequence_level/Blastn/nr/Definitive
if [ -d "$WD1" ]; then
	rm -r $WD1
fi
...
mkdir -p $WD/08-comparative_genomics/Sequence_level/Blastn/nr/Definitive
