...
task_Blastn(){	
	...
	# the alignment.
	Rscript ${10}/Choose_x_best_blast_hits.R $1 $2 $9/03-Blastn/$3/$4/$1\_to\_$2\_temp.tsv $9/03-Blastn/$3/$4/$1\_to\_$2.tsv 5
	...
	# pidet and length of the alignment. Then, we will choose the best hit found for each qseqid taking into account also the e-value, pidet and length of 
	# the alignment.
	Rscript ${10}/Choose_x_best_blast_hits.R $1 $2 $9/03-Blastn/$3/$4/$2\_to\_$1\_temp.tsv $9/03-Blastn/$3/$4/$2\_to\_$1.tsv 5
