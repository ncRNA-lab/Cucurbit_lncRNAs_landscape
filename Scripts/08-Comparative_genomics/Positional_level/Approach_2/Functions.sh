...
task_lncRNAS_NR_and_genes_list(){
	echo -e "\t\t"$1"..."
	
	# Paths.
	DB=$4/05-predict_lncRNAs/$1/STEP-FINAL/Database/Database_LncRNAs_NR.tsv
	G=$4/05-predict_lncRNAs/$1/STEP-FINAL/Files/Genes
	L=$4/05-predict_lncRNAs/$1/STEP-FINAL/Files/LncRNAs/nr
	...
	# Extract sorted IDs.
	Rscript $6/Extract_transcript_ids_from_GTF.R $FOLDER01/$1\_sorted.gtf $FOLDER01/$1\_ids_sorted_temp.txt
...
task_lncRNAS_R_and_genes_list(){
	echo -e "\t\t"$1"..."
	
	# Paths.
	DB=$4/05-predict_lncRNAs/$1/STEP-FINAL/Database/Database_LncRNAs.tsv
	G=$4/05-predict_lncRNAs/$1/STEP-FINAL/Files/Genes
	L=$4/05-predict_lncRNAs/$1/STEP-FINAL/Files/LncRNAs/r
	FOLDER01=$5/01-LncRNAs_and_Genes/$2/$3
...
task_synteny_analysis(){
	...
	>$1/$2/stdout_$8\_$7.log
	Synteny_analysis-Approach_2.py \
		...
		--minOverlap $5 \
		--minSideOverlap $6 \
		--nonMatch $7 >> $1/$2/stdout_$8\_$7.log 2>&1
}
...
task_classify_into_families(){
	...
	Classify_into_families_modified.py \
