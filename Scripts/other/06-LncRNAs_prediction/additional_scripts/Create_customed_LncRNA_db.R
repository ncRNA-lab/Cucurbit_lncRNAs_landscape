...
# specie = "cme"
# WD = "/mnt/doctorado/3-lncRNAs/Cucurbitaceae/Results/05-LncRNAs_prediction/cme"
...
write.table(DB_filt, paste0(WD, "/STEP-FINAL/Database/Database_NC.tsv"), sep = "\t", col.names = T, row.names = F, quote = F)
...
#DB = read.table(paste0(WD, "/STEP-FINAL/Database/Database_ALL.tsv"), sep = "\t", header = T, quote = "\"")
...
#DB_filt = read.table(paste0(WD, "/STEP-FINAL/Database/Database_NC.tsv"), sep = "\t", header = T, quote = "\"")
...
png(filename=paste0(WD, '/STEP-FINAL/Figures/Upset_Classification.png'), height = 5500, width = 7000, res=600)
upset(x,
...
write.table(DB_filt_filt, paste0(WD, "/STEP-FINAL/Database/Database_LncRNAs.tsv"), sep = "\t", col.names = T, row.names = F, quote = F)

#DB_filt_filt = read.table(paste0(WD, "/STEP-FINAL/Database/Database_LncRNAs.tsv"), sep = "\t", header = T, quote = "\"")
...
ggsave(paste0(WD, "/STEP-FINAL/Figures/Class_code_lncRNAs_distribution.png"), height = 7, width = 8, dpi = 600)
