...
F="/storage/ncRNA/Projects/lncRNAs/Cme_stress/Scripts/01-Samples_processing/sra_data/Functions-REPAIR.sh"
...
for SRR in $Samples_to_repair; do
	srun -N1 -n1 -c$SLURM_CPUS_PER_TASK --output $WD1/01-Raw_data/outputs/stdout_Repair_$SRR.log --quiet --exclusive $F task_Repair $SRR &
done
wait
