################################################################################
#
# ALL: TISSUE SPECIFICITY STUDY: APPROACH 1 - STEP 4
#
...
for (spe in species) {
  ...
  # Directories.
  if (!dir.exists(paste0(path_tissue_specificity, "/approach_1/ALL/", flag, "/STEP4"))){
    dir.create(paste0(path_tissue_specificity, "/approach_1/ALL/", flag, "/STEP4"))
  }
  if (!dir.exists(paste0(path_tissue_specificity, "/approach_1/ALL/", flag, "/STEP4/", spe))){
    dir.create(paste0(path_tissue_specificity, "/approach_1/ALL/", flag, "/STEP4/", spe))
  }
  ...
  if (length(files) > 0) {
    ...
    for (SRA.Study in SRA.Studies) {
      ...
      png(filename = paste0(path_tissue_specificity, "/approach_1/ALL/", flag, "/STEP4/", spe, "/", SRA.Study, "_mean-TAU-Heatmap_without_pc.png"), height = 7000, width = 4000, res = 800)
      draw(hmap,
      ...
      png(filename = paste0(path_tissue_specificity, "/approach_1/ALL/", flag, "/STEP4/", spe, "/", SRA.Study, "_mean-TAU-Heatmap_with_pc.png"), height = 7000, width = 4000, res = 800)
      draw(hmap,
           heatmap_legend_side = 'top',
           annotation_legend_side = 'right',
           row_sub_title_side = 'left')
      ...
      write.table(tab_mean_TAU_filt_FINAL, paste0(path_tissue_specificity, "/approach_1/ALL/", flag, "/STEP4/", spe, "/", SRA.Study, "_mean-0.8.tsv"), sep = "\t", quote = F, row.names = F, col.names = T)
...
write.table(TAB_mean_TAU_filt_FINAL, paste0(path_tissue_specificity, "/approach_1/ALL/", flag, "/STEP4/mean-0.8.tsv"), sep = "\t", quote = F, row.names = F, col.names = T)
...
for (spe in species) {
  ...
  if (length(files) > 0) {
    ...
    for (SRA.Study in SRA.Studies) {
      ...
      png(filename = paste0(path_tissue_specificity, "/approach_1/ALL/", flag, "/STEP4/", spe, "/", SRA.Study, "_median-TAU-Heatmap_without_pc.png"), height = 7000, width = 4000, res = 800)
      draw(hmap,
           heatmap_legend_side = 'top',
           annotation_legend_side = 'right',
           row_sub_title_side = 'left')
      ...
      png(filename = paste0(path_tissue_specificity, "/approach_1/ALL/", flag, "/STEP4/", spe, "/", SRA.Study, "_median-TAU-Heatmap_with_pc.png"), height = 7000, width = 4000, res = 800)
      draw(hmap,
           heatmap_legend_side = 'top',
           annotation_legend_side = 'right',
           row_sub_title_side = 'left')
      ...
      write.table(tab_median_TAU_filt_FINAL, paste0(path_tissue_specificity, "/approach_1/ALL/", flag, "/STEP4/", spe, "/", SRA.Study, "_median-0.8.tsv"), sep = "\t", quote = F, row.names = F, col.names = T)
...
write.table(TAB_median_TAU_filt_FINAL, paste0(path_tissue_specificity, "/approach_1/ALL/", flag, "/STEP4/median-0.8.tsv"), sep = "\t", quote = F, row.names = F, col.names = T)
