################################################################################
#
# ALL: TISSUE SPECIFICITY STUDY: APPROACH 1 - STEP 6
#
...
# Directories.
if (!dir.exists(paste0(path_tissue_specificity, "/approach_1/ALL/", flag, "/STEP6"))){
  dir.create(paste0(path_tissue_specificity, "/approach_1/ALL/", flag, "/STEP6"))
}
...
ggsave(paste0(path_tissue_specificity, "/approach_1/ALL/", flag, "/STEP6/mean-TAU-Boxplot.png"), height = 10, width = 10, dpi = 600)
ggsave(paste0(path_tissue_specificity, "/approach_1/ALL/", flag, "/STEP6/mean-TAU-Boxplot.pdf"), height = 10, width = 10, dpi = 600)
...
ggsave(paste0(path_tissue_specificity, "/approach_1/ALL/", flag, "/STEP6/mean-TAU-Boxplot_by_class_code.png"), height = 10, width = 20, dpi = 600)
ggsave(paste0(path_tissue_specificity, "/approach_1/ALL/", flag, "/STEP6/mean-TAU-Boxplot_by_class_code.pdf"), height = 10, width = 20, dpi = 600)
...
# Load table.
TAB_median = read.table(paste0(path_tissue_specificity, "/approach_1/ALL/", flag, "/STEP3/median-TAU.tsv"), sep = "\t", header = T, quote = "\"")
...
ggsave(paste0(path_tissue_specificity, "/approach_1/ALL/", flag, "/STEP6/median-TAU-Boxplot.png"), height = 10, width = 10, dpi = 600)
ggsave(paste0(path_tissue_specificity, "/approach_1/ALL/", flag, "/STEP6/median-TAU-Boxplot.pdf"), height = 10, width = 10, dpi = 600)
...
ggsave(paste0(path_tissue_specificity, "/approach_1/ALL/", flag, "/STEP6/median-TAU-Boxplot_by_class_code.png"), height = 10, width = 20, dpi = 600)
ggsave(paste0(path_tissue_specificity, "/approach_1/ALL/", flag, "/STEP6/median-TAU-Boxplot_by_class_code.pdf"), height = 10, width = 20, dpi = 600)
