...
flag = "nr"
WD1 = paste0("/storage/ncRNA/Projects/lncRNAs/Cucurbitaceae/Results/08-comparative_genomics/Sequence_level/OrthoMCL/", flag, "/Prueba_filters_identity_percentage_and_alignment_length/05-Families")
WD2 = paste0("/storage/ncRNA/Projects/lncRNAs/Cucurbitaceae/Results/08-comparative_genomics/Sequence_level/OrthoMCL/", flag, "/Prueba_filters_identity_percentage_and_alignment_length/06-Figures")
