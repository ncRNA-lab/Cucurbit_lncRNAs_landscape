...
#SBATCH --job-name=OMRdef					# Job name.
#SBATCH --output=OrthoMCL_R_definitive.log			# Standard output and error log.
...
F="/storage/ncRNA/Projects/lncRNAs/Cucurbitaceae/Scripts/Pascual/08-comparative_genomics/Sequence_level/OrthoMCL/Definitive/Functions_R.sh"
...
WD1=$WD/08-comparative_genomics/Sequence_level/OrthoMCL/r/Definitive
if [ -d "$WD1" ]; then
	rm -r $WD1
fi
...
mkdir -p $WD/08-comparative_genomics/Sequence_level/OrthoMCL/r
mkdir -p $WD/08-comparative_genomics/Sequence_level/OrthoMCL/r/Definitive
