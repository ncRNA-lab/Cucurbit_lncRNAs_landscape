...
#SBATCH --job-name=OMNRdef					# Job name.
#SBATCH --output=OrthoMCL_NR_definitive.log			# Standard output and error log.
...
F="/storage/ncRNA/Projects/lncRNAs/Cucurbitaceae/Scripts/Pascual/08-comparative_genomics/Sequence_level/OrthoMCL/Definitive/Functions_NR.sh"
...
WD1=$WD/08-comparative_genomics/Sequence_level/OrthoMCL/nr/Definitive
if [ -d "$WD1" ]; then
	rm -r $WD1
fi
...
mkdir -p $WD/08-comparative_genomics/Sequence_level/OrthoMCL/nr/Definitive
