...
flag = "nr"
WD1 = paste0("/storage/ncRNA/Projects/lncRNAs/Cucurbitaceae/Results/08-comparative_genomics/Sequence_level/OrthoFinder/", flag, "/Prueba_e-value_5/05-Families")
WD2 = paste0("/storage/ncRNA/Projects/lncRNAs/Cucurbitaceae/Results/08-comparative_genomics/Sequence_level/OrthoFinder/", flag, "/Prueba_e-value_5/06-Figures")
