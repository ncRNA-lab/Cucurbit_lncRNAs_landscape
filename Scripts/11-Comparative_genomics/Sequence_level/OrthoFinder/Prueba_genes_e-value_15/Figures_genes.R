...
flag = "nr"
WD1 = paste0("/storage/ncRNA/Projects/lncRNAs/Cucurbitaceae/Results/08-comparative_genomics/Sequence_level/OrthoFinder/", flag, "/Prueba_genes_e-value_15/05-Families")
WD2 = paste0("/storage/ncRNA/Projects/lncRNAs/Cucurbitaceae/Results/08-comparative_genomics/Sequence_level/OrthoFinder/", flag, "/Prueba_genes_e-value_15/06-Figures")
