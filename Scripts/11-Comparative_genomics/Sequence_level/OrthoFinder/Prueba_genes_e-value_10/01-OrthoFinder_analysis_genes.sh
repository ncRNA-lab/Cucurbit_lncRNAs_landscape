...
F="/storage/ncRNA/Projects/lncRNAs/Cucurbitaceae/Scripts/Pascual/08-comparative_genomics/Sequence_level/OrthoFinder/Prueba_genes_e-value_10/Functions.sh"
Species_list="car cla cma cme cmo cpe csa lsi mch"
evalue=1e-10
Scripts=$(pwd)

####### NEW AND OTHER VARIABLES
WD1=$WD/08-comparative_genomics/Sequence_level/OrthoFinder/nr/Prueba_genes_e-value_10
if [ -d "$WD1" ]; then
	rm -r $WD1
fi
...
mkdir -p $WD/08-comparative_genomics/Sequence_level/OrthoFinder/nr/Prueba_genes_e-value_10
