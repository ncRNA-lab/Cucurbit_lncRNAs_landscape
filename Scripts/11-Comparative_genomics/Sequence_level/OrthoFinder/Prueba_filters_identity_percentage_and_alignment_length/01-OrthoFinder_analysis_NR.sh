...
#SBATCH --job-name=OFNRP2					# Job name.
#SBATCH --output=OrthoFinder_NR_P2.log			# Standard output and error log.
...
F="/storage/ncRNA/Projects/lncRNAs/Cucurbitaceae/Scripts/Pascual/08-comparative_genomics/Sequence_level/OrthoFinder/Prueba_filters_identity_percentage_and_alignment_length/Functions_NR.sh"
...
WD1=$WD/08-comparative_genomics/Sequence_level/OrthoFinder/nr/Prueba_filters_identity_percentage_and_alignment_length
if [ -d "$WD1" ]; then
	rm -r $WD1
fi
...
mkdir -p $WD/08-comparative_genomics/Sequence_level/OrthoFinder/nr/Prueba_filters_identity_percentage_and_alignment_length
