...
for (s in strictness) {
  for (n in nonmatch) {
    tab_1_LNCRNAS_TPMs = TAB_1_LNCRNAS_TPMs[TAB_1_LNCRNAS_TPMs$Strictness == s & TAB_1_LNCRNAS_TPMs$NonMatch == n,]
    ...
    ggsave(paste0(WD2, "/", s, "-", n, "-Boxplot_LncRNAs_TPMs_1.png"), height = 8, width = 32, dpi = 600)
    ggsave(paste0(WD2, "/", s, "-", n, "-Boxplot_LncRNAs_TPMs_1.pdf"), height = 8, width = 32, dpi = 600)
    ...
    ggsave(paste0(WD2, "/", s, "-", n, "-Boxplot_LncRNAs_TPMs_2.png"), height = 12, width = 20, dpi = 600)
    ggsave(paste0(WD2, "/", s, "-", n, "-Boxplot_LncRNAs_TPMs_2.pdf"), height = 12, width = 20, dpi = 600)
    ...
    ggsave(paste0(WD2, "/", s, "-", n, "-Boxplot_LncRNAs_TPMs_3.png"), height = 12, width = 20, dpi = 600)
    ggsave(paste0(WD2, "/", s, "-", n, "-Boxplot_LncRNAs_TPMs_3.pdf"), height = 12, width = 20, dpi = 600)
  }
}
