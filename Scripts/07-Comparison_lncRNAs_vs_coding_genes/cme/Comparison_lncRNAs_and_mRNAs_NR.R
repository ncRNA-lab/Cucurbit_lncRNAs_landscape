...
LncRNAs_tab = paste0(pred, "/STEP-FINAL/Files/LncRNAs/nr/POTENTIAL_LNCRNAS_pred.tsv")
DB_path = paste0(pred, "/STEP-FINAL/Database/Database_LncRNAs_NR.tsv")
Quant_tab = paste0(quant, "/Salmon/ALL/nr/04-Table/TPMs_summary.tsv")
...
ggsave(paste0(comp, "/GC_content_by_type_NR.png"), height = 7, width = 8, dpi = 600)
...
ggsave(paste0(comp, "/GC_content_by_type_facet_and_class_code_NR.png"), height = 7, width = 10, dpi = 600)
...
ggsave(paste0(comp, "/Length_by_type_NR.png"), height = 7, width = 10, dpi = 600)
...
ggsave(paste0(comp, "/Length_by_type_facet_NR.png"), height = 7, width = 15, dpi = 600)
...
ggsave(paste0(comp, "/Exons_by_type_facet_NR.png"), height = 7, width = 15, dpi = 600)
...
ggsave(paste0(comp, "/TPMs_by_type_NR.png"), height = 7, width = 8, dpi = 600)
