...
for (type in types) {
  ...
  for (i in 1:length(species_short_name)) {
    ...
    tab_1 = read.table(paste0(WD, "/", species_short_name[i], "/TAB_FINAL_JOIN_1_R.tsv"), sep = "\t", header = T, quote = "\"")
    ...
    tab_2 = read.table(paste0(WD, "/", species_short_name[i], "/TAB_FINAL_JOIN_2_R.tsv"), sep = "\t", header = T, quote = "\"")
  ...
  for (i in 1:length(species_short_name)) {
    ...
    tab_rep = read.table(paste0(repeat_content_path, "/Final_tab-Repeat-R-", str_to_title(unlist(strsplit(type, " "))[2]), "-COLLAPSED_REPEAT.tsv"), sep = "\t", header = T, quote = "\"")
  ...
  write.table(TAB_LONG, paste0(WD, "/ALL/TAB_LONG_ALL_SPECIES-", str_to_title(unlist(strsplit(type, " "))[2]), "-R.tsv"), sep = "\t", col.names = T, row.names = F, quote = F)
  write.table(TAB_WIDE, paste0(WD, "/ALL/TAB_WIDE_ALL_SPECIES-", str_to_title(unlist(strsplit(type, " "))[2]), "-R.tsv"), sep = "\t", col.names = T, row.names = F, quote = F)
  ...
  ggsave(paste0(WD, "/ALL/GC_content-", str_to_title(unlist(strsplit(type, " "))[2]), "-R.png"), height = 5, width = 25, dpi = 600)
  ...
  ggsave(paste0(WD, "/ALL/Exon_number-", str_to_title(unlist(strsplit(type, " "))[2]), "-R.png"), height = 5, width = 25, dpi = 600)
  ...
  ggsave(paste0(WD, "/ALL/Length-", str_to_title(unlist(strsplit(type, " "))[2]), "-R.png"), height = 5, width = 25, dpi = 600)
  ...
  ggsave(paste0(WD, "/ALL/Expression-", str_to_title(unlist(strsplit(type, " "))[2]), "-R.png"), height = 5, width = 25, dpi = 600)
  ...
  ggsave(paste0(WD, "/ALL/Repeat_content-", str_to_title(unlist(strsplit(type, " "))[2]), "-R.png"), height = 5, width = 25, dpi = 600)
  ...
  ggsave(paste0(WD, "/ALL/FINAL-", str_to_title(unlist(strsplit(type, " "))[2]), "-R.png"), height = 25, width = 25, dpi = 600)
  ggsave(paste0(WD, "/ALL/FINAL-", str_to_title(unlist(strsplit(type, " "))[2]), "-R.pdf"), height = 25, width = 25, dpi = 600)
  ...
  write.table(TAB_LONG_SUMMARY, paste0(WD, "/ALL/TAB_LONG_ALL_SPECIES-", str_to_title(unlist(strsplit(type, " "))[2]), "-R-SUMMARY.tsv"), sep = "\t", col.names = T, row.names = F, quote = F)
  write.table(TAB_WIDE_SUMMARY, paste0(WD, "/ALL/TAB_WIDE_ALL_SPECIES-", str_to_title(unlist(strsplit(type, " "))[2]), "-R-SUMMARY.tsv"), sep = "\t", col.names = T, row.names = F, quote = F)
  ...
  write.table(TAB_STATISTICS, paste0(WD, "/ALL/TAB_STATISTICS_ALL_SPECIES-", str_to_title(unlist(strsplit(type, " "))[2]), "-R.tsv"), sep = "\t", col.names = T, row.names = F, quote = F)
...
write.table(TAB_LONG_FINAL, paste0(WD, "/ALL/TAB_LONG_FINAL_ALL_SPECIES-R.tsv"), sep = "\t", col.names = T, row.names = F, quote = F)
write.table(TAB_WIDE_FINAL, paste0(WD, "/ALL/TAB_WIDE_FINAL_ALL_SPECIES-R.tsv"), sep = "\t", col.names = T, row.names = F, quote = F)
write.table(TAB_LONG_SUMMARY_FINAL, paste0(WD, "/ALL/TAB_LONG_FINAL_ALL_SPECIES-R-SUMMARY.tsv"), sep = "\t", col.names = T, row.names = F, quote = F)
write.table(TAB_WIDE_SUMMARY_FINAL, paste0(WD, "/ALL/TAB_WIDE_FINAL_ALL_SPECIES-R-SUMMARY.tsv"), sep = "\t", col.names = T, row.names = F, quote = F)
write.table(TAB_STATISTICS_FINAL, paste0(WD, "/ALL/TAB_STATISTICS_FINAL_ALL_SPECIES-R.tsv"), sep = "\t", col.names = T, row.names = F, quote = F)
...
ggsave(paste0(WD, "/ALL/FINAL-R.png"), height = 25, width = 25, dpi = 600)
ggsave(paste0(WD, "/ALL/FINAL-R.pdf"), height = 25, width = 25, dpi = 600)
...
ggsave(paste0(WD, "/ALL/FINAL-COLLAPSE-R.png"), height = 25, width = 25, dpi = 600)
ggsave(paste0(WD, "/ALL/FINAL-COLLAPSE-R.pdf"), height = 25, width = 25, dpi = 600)
