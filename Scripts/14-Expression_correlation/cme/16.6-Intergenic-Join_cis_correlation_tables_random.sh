...
#SBATCH --job-name=cmeS16U6						# Job name.
#SBATCH --output=cme_STEP16_U6.log					# Standard output and error log.
...
for flag in $flag_list; do
	...
	Rscript $AS/Intergenic-STEP6-Join_cis_correlation_tables-RANDOM.R $O5 $O6
