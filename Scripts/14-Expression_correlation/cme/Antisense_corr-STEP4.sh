...
#SBATCH --job-name=cmeAcorr4						# Job name.
#SBATCH --output=cme_antisense_corr_4.log				# Standard output and error log.
...
for flag in $flag_list; do
	...
	Rscript $AS/Antisense-STEP4-Create_Final_Table.R $O3 $O4
