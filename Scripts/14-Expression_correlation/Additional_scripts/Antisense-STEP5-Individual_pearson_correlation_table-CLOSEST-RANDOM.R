...
# cis-interactions table. Finally, we extract from this table random pairs and we 
# generate the cis-correlation table for each subexperiment. The table only shows 
# lncRNA-PCG interactions and, as we said, for NAT-lncRNAs we only search for the 
# closest gene.
#
