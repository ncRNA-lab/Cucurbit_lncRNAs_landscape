...
AS="/storage/ncRNA/Projects/lncRNAs/Cucurbitaceae_updates/Scripts/"$update"/01-Samples_processing/additional_scripts"
...
WD1_spe=$WD1"/"$specie
Acc_list=$AI"/sra-info/"$update"/accession_list/"$specie"-SRR_Acc_List-Filter_1.txt"
New_Acc_list=$AI"/sra-info/"$update"/accession_list/"$specie"-SRR_Acc_List-Filter_2.txt"
...
echo -e "\nResults:\n"
cat $WD1_spe/03-Strand_detection/Filter_table/Strand_info.tsv
